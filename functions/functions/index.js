...
// Variables
// req.spending -> how much money you spend
// req.checkingAccount -> checkingAccount ID
// req.sparechangeAccount -> sparechangeAccount ID
...
exports.transferRoundedMoney = functions.https.onCall((data, context) => {
    ...
    var roundedValue = Math.round(spending)
    var valueToTransfer = spending - roundedValue
    var options = { 
        method: 'POST',
