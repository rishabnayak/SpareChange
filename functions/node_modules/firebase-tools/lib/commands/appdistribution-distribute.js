...
module.exports = new Command("appdistribution:distribute <distribution-file>")
    ...
    try {
        ...
        throw new error_1.FirebaseError(`App Distribution is not enabled for app ${appId}. Please visit the Firebase Console to get started.`, { exit: 1 });
    }
    if (!app.contactEmail) {
    ...
    let releaseId;
    try {
        releaseId = yield requests.getReleaseIdByHash(releaseHash);
...
//# sourceMappingURL=appdistribution-distribute.js.map