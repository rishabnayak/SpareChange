    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                utils.logLabeledBullet("firestore", `Serving WebChannel traffic on at ${clc.bold(`http://${host}:${webChannelPort}`)}`);
            }
            catch (e) {
                utils.logLabeledWarning("firestore", `Not serving WebChannel traffic, unable to find an open port in range ${port}:${stopPort}]`);
            }
