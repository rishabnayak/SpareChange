...
function listMods(projectId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (instances.length < 1) {
            utils.logLabeledBullet(modsHelper_1.logPrefix, `there are no extensions installed on project ${clc.bold(projectId)}.`);
            return { instances: [] };
        }
        ...
        utils.logLabeledBullet(modsHelper_1.logPrefix, `list of extensions installed in ${clc.bold(projectId)}:`);
