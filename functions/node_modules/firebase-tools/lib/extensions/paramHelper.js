...
function promptForNewParams(spec, newSpec, currentParams, projectId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        paramsDiffDeletions = modsHelper_1.substituteParams(paramsDiffDeletions, firebaseProjectParams);
        let paramsDiffAdditions = _.differenceWith(newSpec.params, _.get(spec, "params", []), _.isEqual);
        paramsDiffAdditions = modsHelper_1.substituteParams(paramsDiffAdditions, firebaseProjectParams);
