    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (projectSetupOption) {
            case OPTION_USE_PROJECT:
                projectMetaData = yield projects_1.getOrPromptProject(options);
                break;
            case OPTION_NEW_PROJECT:
                projectMetaData = yield promptAndCreateNewProject();
                break;
            case OPTION_ADD_FIREBASE:
                projectMetaData = yield promptAndAddFirebaseToCloudProject();
                break;
            default:
                return;
        }
