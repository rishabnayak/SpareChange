...
const modsHelper = require("../../extensions/modsHelper");
...
describe("paramHelper", () => {
    ...
    describe("promptForNewParams", () => {
        ...
        it("should populate the spec with the default value if it is returned by prompt", () => __awaiter(this, void 0, void 0, function* () {
        ...
        it("should exit if a prompt fails", () => __awaiter(this, void 0, void 0, function* () {
            ...
            const newSpec = _.cloneDeep(SPEC);
            newSpec.params = TEST_PARAMS_2;
            yield chai_1.expect(paramHelper.promptForNewParams(SPEC, newSpec, {
                A_PARAMETER: "value",
                ANOTHER_PARAMETER: "value",
            }, PROJECT_ID)).to.be.rejectedWith(error_1.FirebaseError, "this is an error");
